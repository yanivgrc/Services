...
(function(){
  var I18N = {
    ...
    "cred.title":{en:"Certified, audited, accountable.",he:"מקצועיות, בקרה ואחריות."},
    ...
    "hero.sub":{en:"A private cybersecurity, governance and privacy practice run by a working <b>CISO</b> — not a brochure. Two decades of building, breaking and defending systems, distilled into a small set of services for organizations that <b>can't afford to get security wrong.</b>",
      he:"ניהול סייבר, סיכונים ומשילות בהתאמה אישית, בניהול <b>CISO פעיל</b> — לארגונים <b>שלא יכולים להרשות לעצמם טעויות באבטחה או כשלים טכנולוגיים.</b>"},
    "hero.m1":{en:"20+ years across security & engineering",he:"20+ שנות ניסיון באבטחה ובהנדסה"},
    "hero.m2":{en:"Government & enterprise grade",he:"ברמת ממשל ותאגיד"},
    ...
    "c7.p":{en:"Technology advisory grounded in a CTO background — architecture, modernization and digital transformation guided by security from day one.",
      he:"ייעוץ טכנולוגי מתוך רקע של CTO — ארכיטקטורה, מודרניזציה וטרנספורמציה דיגיטלית, מונחים באבטחה מהיום הראשון."},
    ...
    "p5.p":{en:"Location and long-range telemetry over GPS and LoRa — tracking and sensing where conventional networks don't reach.",
      he:"מיקום וטלמטריה לטווח ארוך מעל GPS ו-LoRa — מעקב וחישה במקומות שרשתות רגילות לא מגיעות אליהם."},
    ...
    "ch.h":{en:"For those who like to look closer.",he:"למי שאוהב להסתכל מקרוב."},
    "ch.p":{en:"A series of cyber puzzles is on the way — for the curious, the stubborn, and anyone who reads the things most people scroll past. Solve them, and you'll find your way in.",
      he:"סדרת חידות סייבר בדרך — לסקרנים, לעקשנים, ולכל מי שקורא את מה שרובם גוללים מעליו. פתרו אותן, ותמצאו את הדרך פנימה."},
    ...
    "contact.btn":{en:"connect on LinkedIn",he:"התחברות בלינקדאין"},
